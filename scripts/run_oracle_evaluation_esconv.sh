...
OUTPUT_DIR="${OUTPUT_DIR:-artifacts/evaluations/oracle_eval_runs/${RUN_TAG}_oracle_esconv_v2}"
...
echo "========================================"
echo "ESConv Oracle evaluation started at $(date)"
...
echo "========================================"
echo "ESConv Oracle evaluation completed at $(date)"
