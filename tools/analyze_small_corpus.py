...
def resolve_analysis_azure_api_key(model: str = "") -> str:
...
def resolve_analysis_azure_endpoint(model: str) -> str:
...
def resolve_analysis_azure_api_version(model: str) -> str:
...
class OpenAIResponsesGenerator:
    ...
    def generate(
        ...
        *,
        ...
        azure_endpoint = resolve_analysis_azure_endpoint(model)
        azure_api_key = resolve_analysis_azure_api_key(model)
        azure_api_version = resolve_analysis_azure_api_version(model)
